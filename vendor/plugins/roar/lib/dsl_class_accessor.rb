# Credit: http://blog.caboo.se/articles/2006/12/25/ds_
# Source: http://wota.jp/svn/rails/plugins/branches/stable/dsl_accessor/
# Author: Maiha anna@wota.jp
class Class
  def dsl_class_accessor(name, options = {})
